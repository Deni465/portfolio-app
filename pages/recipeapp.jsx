...
// @ts-ignore
import Recipeapp from "../public/assets/projects/recipeapp.png";
        ...
        <div className="w-full">
            ...
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
                <div className="col-span-4">
                    ...
                    <h2>Overview</h2>
                    <p className="my-4">
                        This recipe app is a platform that allows users to
                        search for and add new recipes. It was created using a
